...
ExtendedToDouble
	...
	; TODO: SNaN support: "The FPU implements two different types of NANs identified by the value of the MSB of the
	; mantissa for single- and double-precision, and the MSB of the mantissa minus one for
	; extended-precision. If the bit is set, it is a nonsignaling NAN, otherwise, it is an SNAN."
	cmp.l		#$7fff0000,d1
	bne.s		.NoNaN
	move.l		d3,d1
	andi.l		#$7fffffff,d1
