...
GetEa
    ...
    ; TODO: remove below hack, make sure that getea will not be called for reg,reg
	btst.l				#14,INSTRUCTION
	bne.s				.NoRegReg
	bfextu				INSTRUCTION{19:3},d1
	lsl.b				#3,d1
...
GetEaVectors
	ifd STACKEA
		...
		bra.w	EaStackFrame			; 101111 (d16,a7)
		...
		bra.w	EaStackFrame			; 110111 (bd,a7,xn)
		...
		bra.w	EaAnIndirectDisplace	; 101111 (d16,a7)
		...
		bra.w	EeMode111				; 110111 (bd,a7,xn)
